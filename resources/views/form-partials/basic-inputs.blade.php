...
<x-text-input label="Disabled" name="example-disabled-input" placeholder="Disabled..."
    value="Well, she turned me into a newt." :disabled="true" />
<x-text-input label="Readonly" name="example-readonly-input" placeholder="Readonly..."
    value="Well, how'd you become king, then?" :readonly="true" />
