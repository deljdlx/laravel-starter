          ...
          <div class="navbar-nav flex-row order-md-last">
                      ...
                      <div class="row g-0">
                        <div class="col-4">
                          <a href="#" class="d-flex flex-column flex-center text-center text-secondary py-2 px-2 link-hoverable">
                            <img src="./build/icons/tabler/outline/brand-x.svg" class="w-6 h-6 mx-auto mb-2" width="24" height="24" alt="" />
            ...
            <div class="nav-item dropdown">
              <a href="#" class="nav-link d-flex lh-1 p-0 px-2" data-bs-toggle="dropdown" aria-label="Open user menu">
                <span class="avatar avatar-sm" style="background-image: url(./icons/tabler/outline/user.svg"> </span>
