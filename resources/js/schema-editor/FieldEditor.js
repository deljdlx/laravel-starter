...
export class FieldEditor {
    ...
    generateEditorHTML(fieldData, isEditing) {
        return `
            <div class="field-editor-form" style="background: #f8fafc; padding: 1rem; border-radius: 6px; margin-bottom: 1rem;">
                ...
                <div class="property-field">
                    <label style="display: flex; align-items: center; cursor: pointer;">
                        <input type="checkbox" id="field-index-input" ${fieldData.index ? 'checked' : ''} style="width: auto; margin-right: 0.5rem;" />
                        Index
                    </label>
                </div>
                <div class="property-field">
    ...
    saveField(isEditing, fieldIndex) {
        ...
        const index = document.getElementById('field-index-input').checked;
