...
class Container_a3fdbb504b extends _PHPStan_5930232b5\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0364(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_a3fdbb504b $container)
			{
	...
	public function createServiceContainer(): Container_a3fdbb504b
	{
		return $this;
	}
