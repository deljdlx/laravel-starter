...
class CreateAdminUser extends Command
{
    ...
    public function handle(): int
    {
        ...
        $isInteractive = $this->option('interactive') === true ||
                        (! is_string($nameOption) || $nameOption === '' ||
                         ! is_string($emailOption) || $emailOption === '' ||
        ...
        return $this->createUser($nameOption, $emailOption, $passwordOption);
    }
    ...
    private function createUser(string $name, string $email, string $password): int
    {
        try {
            ...
            // Assign admin role (create if it doesn't exist)
